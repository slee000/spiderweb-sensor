function plotIGES(ParameterData,srf,fignr,subd,holdoff_flag,fine_flag,plotCrvPnts,srfClr)
...
for i=1:siz
    ...
    if strcmp( ParameterData{i}.name , 'LINE' )
        if isfield( ParameterData{i} , 'color' )
            line_color = ParameterData{i}.color ;
        else
        ...
        plot3( [ ParameterData{i}.p1(1) ParameterData{i}.p2(1) ] , [ ParameterData{i}.p1(2) ParameterData{i}.p2(2) ] , [ ParameterData{i}.p1(3) ParameterData{i}.p2(3) ] , 'Color', line_color)
        % plot3( 100-[ ParameterData{i}.p1(2) ParameterData{i}.p2(2) ] , 100-[ ParameterData{i}.p1(1) ParameterData{i}.p2(1) ] , [ ParameterData{i}.p1(3) ParameterData{i}.p2(3) ] , 'Color', line_color) % mirrored w.r.t. y=-x for EPFL publication
        % plot( [ ParameterData{i}.p1(1) ParameterData{i}.p2(1) ] , [ ParameterData{i}.p1(2) ParameterData{i}.p2(2) ] )
        hold on
